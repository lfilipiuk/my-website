      ...
      <main className={"bg-gray-900 font-inter my-32"}>
                ...
                <li className={"border-l-2 border-gray-600"}>
                  <div className="flex flex-start items-center">
                    ...
                    <h4 className="text-gray-200 font-semibold text-lg -mt-2 ml-1">
                      Consulting at LabMasters and Exploring fullstack
                      development
                    </h4>
                  </div>
        ...
        <Section>
          <>
            ...
            <div className={"text-white italic text-gray-400 py-3 leading-7"}>
              <p>
                “Łukasz has good contact with the course participants, he
                explains the material very well, he can answer any question and{" "}
                <span className={"font-bold text-gray-200"}>
